              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="col-span-2">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <div className="flex gap-1 ml-auto">
                      {(['fr', 'en'] as DescLang[]).map((l) => (
                        <button key={l} onClick={() => setDescLang(l)} className={`px-2 py-0.5 rounded font-mono text-xs transition-colors ${descLang === l ? 'bg-[var(--bg-high)] text-[var(--cyan)] border border-[var(--cyan)]' : 'text-[var(--text-muted)] border border-[var(--border)] hover:text-[var(--text)]'}`}>
                          {l.toUpperCase()}
                        </button>
                      ))}
                    </div>
